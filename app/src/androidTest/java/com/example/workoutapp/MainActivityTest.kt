...
class MainActivityTest {
    ...
    @Test fun verifyButtonsAreDisplayed() {
    ...
    @Test fun verifyButtonsAreClickable() {
    ...
    @Test fun userCanNavigateToBMICalendarActivity() {
